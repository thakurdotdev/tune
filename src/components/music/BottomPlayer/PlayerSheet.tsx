...
import { ChevronDown, Download, ListMusic, MoreHorizontal, Music, Share2 } from 'lucide-react';
...
const PlayerSheet = memo(({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
              ...
              <SheetHeader className="p-0">
                <div className="flex items-center justify-between">
                  ...
                  <DropdownMenu>
                    ...
                    >
                      <DropdownMenuItem onClick={handleModalOpen} className="cursor-pointer">
